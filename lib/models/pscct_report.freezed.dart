...
class _$_PSCCTReport extends _PSCCTReport {
  ...
  @override
  String toString() {
    return 'PSCCTReport(Title: $Title, Description: $Description, CategoryText: $CategoryText, RawData: $RawData, OrderOnApp: $OrderOnApp, ComponentKey: $ComponentKey, ImageKey: $ImageKey, IsGeneric: $IsGeneric, ChartType: $ChartType, DataSourceNav: $DataSourceNav, IsCurrencyFormat: $IsCurrencyFormat, ShowOnApp: $ShowOnApp, DecimalDigits: $DecimalDigits, Uom: $Uom, Category: $Category, IsCard: $IsCard)';
  }
...
abstract class _PSCCTReport extends PSCCTReport {
  const factory _PSCCTReport(
      ...
      required final String ComponentKey,
      required final String ImageKey,
      required final bool IsGeneric,
      ...
      final bool IsCard}) = _$_PSCCTReport;
